...
const NewCommentForm = () => {
  ...
  const lastCommentId = useSelector(
    (state) => state.comments.data[state.comments.data.length - 1]?.id
  );
      ...
      <div>
        <FormWrapper>
          <HeaderWrapper>
            ...
            <CloseButton
              onClick={() => dispatch({ type: "newCommentForm/hide" })}
            >
              <svg
          ...
          <FormItem>
            ...
            {newCommentErrors.name && (
              <Label error>Pole nie może być puste.</Label>
            )}
          </FormItem>
          <FormItem>
            ...
            />
            {newCommentErrors.email === "empty" && (
              <Label error>Pole nie może być puste.</Label>
            )}
            {newCommentErrors.email === "invalid" && (
              <Label error>Niepoprawny e-mail.</Label>
            )}
          </FormItem>
          <FormItem>
            <Label>Treść</Label>
