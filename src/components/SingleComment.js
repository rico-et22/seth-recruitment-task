...
const SingleComment = (props) => {
  ...
  const saveEditedData = () => {
    ...
    if (!emptyName && !emptyEmail && !invalidEmail && !emptyBody) {
      fetch(
        `https://jsonplaceholder.typicode.com/comments/${editModeData.id}`,
        {
          method: "PUT",
    ...
    return (
      <tr>
        ...
        <td>
          ...
          />
          {editedCommentErrors.name && (
            <ErrorMessage>Pole nie może być puste.</ErrorMessage>
          )}
        </td>
        <td>
          <Input
          ...
          />
          {editedCommentErrors.email === "empty" && (
            <ErrorMessage>Pole nie może być puste.</ErrorMessage>
          )}
          {editedCommentErrors.email === "invalid" && (
            <ErrorMessage>Niepoprawny e-mail.</ErrorMessage>
          )}
        </td>
        <td>
          <TextArea
      ...
      <tr>
        ...
        <td>
          ...
          {showDeleteErrorMessage && (
            <ErrorMessage>Błąd usuwania.</ErrorMessage>
          )}
        </td>
        <td>
          <ActionButton
